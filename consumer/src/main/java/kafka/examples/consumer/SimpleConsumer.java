...
public class SimpleConsumer<K extends Serializable, V extends Serializable> implements Runnable {
    ...
    private static Properties getConsumerConfigs(Namespace result) {
        ...
        configs.put("ssl.truststore.location", "/home/lin/apps/jdk13/lib/security/cacerts");
        configs.put("ssl.truststore.password", "changeit");
        configs.put("ssl.truststore.type", "JKS");
        configs.put("ssl.keystore.location", "/home/lin/apps/bin-gen-ssl-keys/keystore-client.jks");/**/
        configs.put("ssl.keystore.password", "12345678");
        configs.put("ssl.keystore.type", "JKS");
        configs.put("ssl.key.password", "12345678");
        configs.put("ssl.enabled.protocols", "TLSv1.2");
        configs.put("ssl.secure.random.implementation", "SHA1PRNG");
